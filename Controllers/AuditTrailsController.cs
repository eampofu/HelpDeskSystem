...
namespace HelpDeskSystem.Controllers
{
    public class AuditTrailsController : Controller
    {
        ...
        public async Task<IActionResult> Create( AuditTrail auditTrail)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "FullName", auditTrail.UserId);
            return View(auditTrail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, AuditTrail auditTrail)
        {
            if (id != auditTrail.Id)
            {
                return NotFound();
